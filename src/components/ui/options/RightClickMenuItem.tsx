...
export function RightClickMenuItem({ item, level = 0 }: RightClickMenuItem) {
    ...
    return (
        <div className="w-54 h-7.5 relative" onMouseEnter={() => setHasHovered(true)} onMouseLeave={() => setHasHovered(false)}>
            <div className="w-auto h-auto flex justify-between items-center rotate-0.5 gap-2 bg-transparent">
                <div className="gap-2 flex justify-center items-center">
                    <div className="w-4 h-4 flex items-center justify-center"><img src={item.iconPath} alt={item.iconDescription} className="w-auto" /></div>
