...
export function PlayButtonPlayer({ isPlaying, onClick }: PlayButtonPlayerProps) {
    return (
        <button
            className={`w-6 h-6 flex p-1.5 bg-text-base items-center cursor-pointer justify-center rounded-full ease-out duration-300 hover:border hover:border-text-base`}
            onClick={onClick}
        >
