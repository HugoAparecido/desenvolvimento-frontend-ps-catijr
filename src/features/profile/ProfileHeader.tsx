...
export function ProfileHeader({ profile }: ProfileHeaderProps) {
    return (
        <div className="w-full h-max flex bg-profile-header pt-10 px-5 pb-4 gap-2.5 rounded-t-xl overflow-hidden">
            <div className="w-max h-max flex gap-3 items-center">
                ...
                <div className="flex gap-2.5 flex-col min-w-0 w-full">
                    ...
                    <div className="flex gap-1 items-center text-xs font-medium font-default-font text-text-subdued lining-none truncate">
